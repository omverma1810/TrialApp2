  ...
  COLORS: {
    ...
    COMPONENTS: {
      ...
      CHIP: {
        PRIMARY_COLOR: '#1A6DD2',
        SECONDARY_COLOR: '#FFF',
        ACTIVE_BORDER_COLOR: '#1A6DD2',
        INACTIVE_BORDER_COLOR: '#1A6DD2',
        TEXT_COLOR: '#FFF',
      },
      TOAST: {
        INFO_BACKGROUND_COLOR: '#EBF8FF',
        INFO_TEXT_COLOR: '#000',
        SUCCESS_BACKGROUND_COLOR: '#F4F9E7',
        SUCCESS_TEXT_COLOR: '#000',
        WARNING_BACKGROUND_COLOR: '#FCF1E3',
        WARNING_TEXT_COLOR: '#000',
        ERROR_BACKGROUND_COLOR: '#FBE8E7',
        ERROR_TEXT_COLOR: '#000',
        NATIVE_BACKGROUND_COLOR: 'rgba(76,80,79,0.5)',
        NATIVE_TEXT_COLOR: '#FFFFFF',
      },
      RADIO_BUTTON: {
      ...
      SWITCH: {
        ACTIVE_COLOR: '#00BC0E',
        INACTIVE_COLOR: '#262626',
        DOT_COLOR: '#FFFFFF',
      },
      PICKER: {
        BACKGROUND_COLOR: '#FFF',
        ACTIVE_BORDER_COLOR: '#B7B7B7',
        INACTIVE_BORDER_COLOR: '#B7B7B7',
        TEXT_COLOR: '#161616',
