...
const Record = () => {
    const [selectedExperiment, setSelectedExperiment] = useState<Chip | null>(null);
    ...
    const [selectedFieldData, setSelectedFieldData] = useState<SelectedFieldData | null>(null);
        ...
        <SafeAreaView>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={RecordStyles.container}>
                            ...
                            <View style={RecordStyles.experimentItem}>
                                ...
                                <View style={RecordStyles.experimentRow}>
                                    <Text style={RecordStyles.experimentText}>
                                        {selectedExperiment.ExperientName || 'Experiment Name Not Available'}
                                    </Text>
                                    <DropdownArrow />
                                </View>
                    ...
                    {!inputVisible && (
                        <Chip onPress={handleSecondBottomModalOpen}
