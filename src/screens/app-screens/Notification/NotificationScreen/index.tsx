...
import { Alert, Clock, List } from '../../../../assets/icons/svgs';
      ...
      <View style={styles.card}>
        <View style={styles.row}>
          ...
          <View style={styles.reminderTextContainer}>
            ...
            <Text style={styles.bodyText}>
              You have a field visit scheduled for tomorrow. Don't forget to check the latest records and take notes
            </Text>
          </View>
        </View>
      </View>
      <View style={styles.alertCard}>
        <View style={styles.row}>
          ...
          <View style={styles.textContainer}>
            ...
            <Text style={styles.bodyText}>
              {NotifiationData.experiment} -{'>'} {NotifiationData.plot}, {NotifiationData.location}
            </Text>
