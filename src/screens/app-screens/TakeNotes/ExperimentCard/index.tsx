...
const ExperimentCard = ({ data, isFirstIndex, isLastIndex ,onExperimentSelect,name,onFieldSelect}: any) => {
    ...
    >
        ...
        <View style={TakeNotesStyles.chipItem}>
          ...
          <View style={TakeNotesStyles.chipTextRow}>
            <Text style={TakeNotesStyles.chipText}>
              {name=="field"?selectedExperiment.location.villageName:selectedExperiment.fieldExperimentName}
            </Text>
            <DropdownArrow />
          </View>
      ...
      >
        <View style={TakeNotesStyles.modalContainer}>
          <Text style={TakeNotesStyles.modalTitle}>Select an Experiment (or) Field</Text>
          <ScrollView>
            <View style={{ gap: 30 }}>
              {Array.isArray(data) && data.map((item: any, index: number) => (
                ...
                >
                  ...
                  {name=="field"?item.location.villageName:item.fieldExperimentName}
                  </Text>
                  <Text
                    style={[
